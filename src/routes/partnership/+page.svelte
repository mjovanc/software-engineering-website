<script lang="ts">
  ...
  let pageTitle = 'Partnership - Software Engineering Community';
...
<div class="mt-6 max-w-4xl">
  ...
  <ul class="list-disc list-inside mt-4 regular-font text-black dark:text-gray">
    ...
    <li><strong>Downloadable Resources:</strong> Promote templates, toolkits, and other valuable resources.</li>
  </ul>

  <h3 class="text-lg regular-font uppercase text-black dark:text-white mt-6">Duration and Pricing</h3>
  ...
  <ol class="list-decimal list-inside mt-4 regular-font text-black dark:text-gray">
    <li class="mt-2">
      <strong>Submit for Approval:</strong> Provide the post you wish to promote. We will review it to ensure it meets our community standards.
    </li>
    <li class="mt-2">
      <strong>Schedule and Payment:</strong> Once approved, your post will be scheduled. Payment is required 24 hours before the posting date to secure your slot.
    </li>
    <li class="mt-2">
      <strong>Post and Pin:</strong> Your approved post will be pinned at the top of our community, and alerts will be sent to members with notifications enabled to maximize visibility and engagement.
    </li>
  </ol>
</div>
